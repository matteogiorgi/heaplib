...
)
{
    ...
    if (strcmp(name, "randomized_skiplist") == 0) {
        *implementation = PRIORITY_QUEUE_RANDOMIZED_SKIPLIST;
        return 0;
    }

    PyErr_SetString(
        PyExc_ValueError,
        "implementation must be 'binary_heap' or 'randomized_skiplist'"
    );
    return -1;
}
...
/*
 * Method table exposed on pqlib.PriorityQueue.
 */
...
/*
 * Python type object for pqlib.PriorityQueue.
 */
static PyTypeObject PyPriorityQueueType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "pqlib.PriorityQueue",
...
/*
 * Module definition for the single-extension pqlib module.
 */
static PyModuleDef pqlibmodule = {
    PyModuleDef_HEAD_INIT,
    .m_name = "pqlib",
    .m_doc = "Python bindings for pqlib priority queues.",
    .m_size = -1,
};
 ...
 */
PyMODINIT_FUNC PyInit_pqlib(void)
{
    PyObject *module;
    ...
    module = PyModule_Create(&pqlibmodule);
    if (module == NULL)
        return NULL;
